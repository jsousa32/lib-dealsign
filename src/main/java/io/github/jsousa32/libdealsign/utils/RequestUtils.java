...
public final class RequestUtils {
        ...
        public static <T, R> Optional<Set<T>> postSet(
                        final String aBearer,
                        final String anUlr,
                        final R anInput,
                        final ParameterizedTypeReference<Set<T>> responseType) {
                final var httpEntity = HeadersUtils.generate(aBearer, anInput);
        ...
        public static <T> Optional<T> patch(
                ...
                final var req = HttpRequest
                                ...
                                .method(HttpMethod.PATCH.name(),
                                                HttpRequest.BodyPublishers.ofString(ConverterUtils.toString(anInput)))
